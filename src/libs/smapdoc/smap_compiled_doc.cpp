...
static const achar		s_SMAPMagic[s_SMAPMagicSize] = { 'S', 'M', 'A', 'P', 'C' };		// Singularity Map Compiled
...
==================
*/
bool CSMAPCompiledMapDoc::SaveFile( const achar* pPath )
{
...
==================
*/
bool CSMAPCompiledMapDoc::LoadFromFile( const achar* pPath )
{
	// Do nothing if the file system isn't valid
	PROFILE_SCOPE( PROFILE_SCOPE_GROUP_IO );
	Assert( g_pFileSystem );
