...
SET BUILD_TARGETS=resourcecompiler
SET INSTALL_DIR=%~2
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
:: Configure cmake
cmake -G "Ninja" -DCMAKE_INSTALL_PREFIX="%INSTALL_DIR%" -DCMAKE_BUILD_TYPE=%BUILD_CONFIGURATION% -DINSTALL_DEV_TOOLS=OFF -DCMAKE_TOOLCHAIN_FILE="%ROOT_DIR%/src/cmake/toolchains/windows/msvc_toolchain.cmake" "%ROOT_DIR%/src"
