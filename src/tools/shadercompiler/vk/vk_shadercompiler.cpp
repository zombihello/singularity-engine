...
==================
*/
static void SpvOptimizer_MessageConsumer( spv_message_level_t level, const achar* pSource, const spv_position_t& position, const achar* pMessage )
{
	switch ( level )
	{
	case SPV_MSG_DEBUG:
...
==================
*/
bool CShaderCompilerBackendVk::CompileShader( const achar* pSrcFileName, const achar* pFunctionName, studioAPIShaderType_t type, IShaderCompilerEnvironment* pEnvironment, IShaderCompilerOutput* pOutput )
{
	...
	shaderc::PreprocessedSourceCompilationResult	shadercPreprocessedSourceResult = shadercCompiler.PreprocessGlsl( ( achar* )pBuffer, fileSize, shadercShaderKind, pSrcFileName, shadercCompileOptions );
...
==================
*/
const achar* CShaderCompilerBackendVk::GetShaderPlatform() const
{
	return "vk";
}