...
public:
	 ...
	 */
	FORCEINLINE bool IsA( jsonValueType_t type ) const
	{
		return CJsonValue::type == type;
	}

	/**
	 * @brief Is JSON value is number type
	 * @return Return TRUE if type value is number, otherwise FALSE
	 */
	 ...
	 */
	FORCEINLINE jsonValueType_t GetType() const
	{
		return type;
	}
...
private:
	jsonValueType_t	type;		/**< Type of value */
