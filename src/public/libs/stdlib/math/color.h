...
public:
	 ...
	 */
	FORCEINLINE CColor( const vec4_t& linearColor )
	{
		Set( linearColor );
	}
	 ...
	 * @param linearColor	Linear color
	 */
	FORCEINLINE void Set( const vec4_t& linearColor )
	{
	...
	/**
	 * @brief Convert CColor to vec4_t
	 * @return Return converted CColor to vec4_t
	 */
	FORCEINLINE vec4_t ToVector4D() const
	{
		return vec4_t( r, g, b, a );
	}

	/**
	 * @brief Convert CColor to normalized vec4_t (in range 0 -> 1)
	 * @return Return converted CColor to normalized vec4_t (in range 0 -> 1)
	 */
	FORCEINLINE vec4_t ToNormalizedVector4D() const
	{
