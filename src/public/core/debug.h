...
CORE_INTERFACE void Msg( const char* pFormat, ... );
CORE_INTERFACE void Warning( const char* pFormat, ... );
CORE_INTERFACE void Error( const char* pFormat, ... );

// Functions for logging in 'developer' group
CORE_INTERFACE void DevMsg( const char* pFormat, ... );
CORE_INTERFACE void DevWarning( const char* pFormat, ... );
CORE_INTERFACE void DevError( const char* pFormat, ... );
#else
...
//-----------------------------------------------------------------------------
#if ENABLE_ASSERT
CORE_INTERFACE bool Sys_AssertFailed( const char* pExpr, const char* pFile, int32 line, const char* pFormat = "", ... );
...
//-----------------------------------------------------------------------------
#if ENABLE_ENSURE
CORE_INTERFACE bool Sys_EnsureFailed( const char* pExpr, const char* pFile, int32 line, bool bAlways, const char* pFormat = "", ... );
