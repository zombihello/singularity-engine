...
#define ENGINE_REVISION		  GIT_COMMIT
#define ENGINE_VERSION		  PACK_VERSION( ENGINE_VERSION_MAJOR, ENGINE_VERSION_MINOR, ENGINE_VERSION_PATCH )
#define ENGINE_VERSION_STRING STRINGIFY( ENGINE_VERSION_MAJOR ) "." STRINGIFY( ENGINE_VERSION_MINOR ) "." STRINGIFY( ENGINE_VERSION_PATCH ) "-" ENGINE_BRANCH_NAME "_" ENGINE_REVISION
