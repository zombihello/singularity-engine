...
public:
	...
	virtual profileDescription_t CreateDescription( const char* pFunctionName, const char* pFileName, uint32 fileLine, const char* pScopeName = NULL, profileScopeGroup_t scopeGroup = PROFILE_SCOPE_GROUP_NONE ) = 0;
	virtual profileDescription_t CreateDescription( const char* pFunctionName, const char* pFileName, uint32 fileLine, profileScopeGroup_t scopeGroup )															 = 0;

	virtual void StartThreadScope( const char* pThreadName ) = 0;
	...
	virtual void AttachTag( profileDescription_t pDescription, const char* pValue )				= 0;
	virtual void AttachTag( profileDescription_t pDescription, const char* pValue, uint16 length ) = 0;
...
TIER0_INTERFACE IProfile* Profile();
...
{
public:
	CProfileThreadScope( const char* pThreadName )
	{
