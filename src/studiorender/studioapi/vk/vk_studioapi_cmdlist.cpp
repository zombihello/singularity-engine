...
==================
*/
void CStudioAPICmdListBatchVk::SyncSignal( const achar* pSyncName )
{
	PROFILE_SCOPE( PROFILE_SCOPE_GROUP_RENDERING );
...
==================
*/
void CStudioAPICmdListBatchVk::SyncWait( const achar* pSyncName )
{
	PROFILE_SCOPE( PROFILE_SCOPE_GROUP_RENDERING );
	Assert( pSyncName && pSyncName != "" );
...
==================
*/
void CStudioAPICmdListBatchVk::RemoveSyncSignal( const achar* pSyncName )
{
	PROFILE_SCOPE( PROFILE_SCOPE_GROUP_RENDERING );
...
==================
*/
void CStudioAPICmdListBatchVk::RemoveSyncWait( const achar* pSyncName )
{
	PROFILE_SCOPE( PROFILE_SCOPE_GROUP_RENDERING );
