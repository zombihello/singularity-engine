...
const achar* VK_ConvVkResultToText( VkResult vkResult );
const achar* VK_ConvVkPresentModeToText( VkPresentModeKHR vkPresentMode );
const achar* VK_ConvVkFormatToText( VkFormat vkFormat );
