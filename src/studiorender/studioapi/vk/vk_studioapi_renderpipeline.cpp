...
==================
*/
CStudioAPIRenderPipelineVk::CStudioAPIRenderPipelineVk( const studioAPIRenderPipelineCreateInfo_t& createInfo, const achar* pDebugName /* = "" */ )
	: vkPipeline( VK_NULL_HANDLE )
	, pStudioAPIVkShutdownDelegate( NULL )
{
	PROFILE_SCOPE( PROFILE_SCOPE_GROUP_RENDERING );
	Assert( createInfo.pBoundShaderState && createInfo.pRenderPass && 
			( createInfo.colorBlendState.attachmentCount == 0 || createInfo.colorBlendState.pAttachments ) );
