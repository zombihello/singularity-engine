...
public:
	...
	virtual TRefPtr<IStreamDataReader> CreateFileReader( const char* pPath, uint32 flags = FILE_READ_NONE ) override;
	...
	virtual TRefPtr<IPathArrayResult> GetSearchPath( const char* pPathID ) const override;
